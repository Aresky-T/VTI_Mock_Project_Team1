            ...
            <div className="create-container-form">
               <form encType="multipart/form-data">
                  <ul>
                     ...
                     <li className="form-line">
                        ...
                        <div className="form-input">
                           ...
                           <button type="button" id="add-step-icon">
                              Add Step
                           </button>
                        </div>
                     </li>
                     ...
                     <li className="form-line">
                        <label className="form-label image" htmlFor="input-image">
                           Image:{" "}
                        </label>
                        <div className="form-input upload-image-container">
                           <div className="upload-image" title="Upload your image" ref={uploadRef}>
                              Browse Files
                           ...
                           <ul className="upload-list">
                              {imageFile && (
                                 <li className="image-container">
                                    ...
                                    <span className="delete-icon" onClick={() => setImageFile(null)}>
                                       <AiOutlineDelete />
                                    </span>
                                 </li>
                              )}
                  ...
                  <div className="submit-button">
                     <button type="button" onClick={upLoadFilesForCreate}>
                        Submit
                     </button>
                  </div>
               </form>
