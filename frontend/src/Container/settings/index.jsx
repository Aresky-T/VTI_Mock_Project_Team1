...
const SettingsContainer = () => {
  ...
  const primaryColors = useSelector(
    (state) => state.settings.primaryColors.primaryColors
  );
  const fontSizes = useSelector((state) => state.settings.fontSizes.fontSizes);
  const animationSpeeds = useSelector(
    (state) => state.settings.animationSpeeds.animationSpeeds
  );
